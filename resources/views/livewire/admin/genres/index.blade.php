            ...
            <table class="min-w-full divide-y divide-slate-700">
                ...
                <tbody class="divide-y divide-slate-700">
                    @forelse ($genres as $genre)
                        <tr wire:key="{{ $genre->id }}" class="hover:bg-slate-700/30 transition-colors duration-200 group">

                            <td class="px-6 py-3 whitespace-nowrap">
                                <div class="text-sm font-bold text-gray-100 group-hover:text-amber-500 transition-colors">{{ $genre->name }}</div>
                            </td>
